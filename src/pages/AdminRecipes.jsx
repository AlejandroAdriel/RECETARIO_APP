  ...
  if (role !== "admin") {
    return (
      <div className="container">
        ...
        <div className="panel">
          <div className="panel-inner">No tienes permisos para editar recetas.</div>
        </div>
      </div>
    );
  }
        ...
        <div className="panel-inner" style={{ display: "grid", gap: 16 }}>
          ...
          {!loading && !errorMsg && (
            <div className="admin-recipes-list">
              {list.map((r) => (
                <div key={r.id} className="admin-recipe-row">
                  <div className="admin-recipe-row-inner">
                    <img src={r.image} alt={r.name} />
                    <div className="admin-recipe-row-main">
                      <strong>{r.name}</strong>
                      <div className="admin-recipe-row-meta">
